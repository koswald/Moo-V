...
public class AppConfig {
	...
	public static final String ACCESS_CONTROL_ALLOW_ORIGIN = "http://*catalystsolves.com*, http://localhost*, http://lap5*, http://172.17.70.*, http://172.17.30.*, http://192.168.1.*"; // ** can cross / boundary so use sparingly if ever; * and ? are supported too
